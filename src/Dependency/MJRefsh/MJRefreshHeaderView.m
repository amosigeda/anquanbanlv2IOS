...
- (void)updateTimeLabel
{
    ...
    if ([cmp1 day] == [cmp2 day]) { // 今天
        formatter.dateFormat =[NSString stringWithFormat:@"%@ HH:mm",NSLocalizedString(@"today", nil)];
    ...
    // 3.显示日期
  //  self.lastUpdateTimeLabel.text = [NSString stringWithFormat:@"%@:%@", NSLocalizedString(@"", nil) ,time];
}
