...
- (void)creatButtonsWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructionButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitlesArray
{
    ...
    if (title) {
        ...
        self.LXActionSheetHeight = self.LXActionSheetHeight + 2*TITLE_INTERVAL_HEIGHT+TITLE_HEIGHT-15;
    ...
    if (destructiveButtonTitle) {
        ...
        if (self.isHadTitle == YES) {
            ...
            if (otherButtonTitlesArray && otherButtonTitlesArray.count > 0) {
                self.LXActionSheetHeight = self.LXActionSheetHeight + destructiveButton.frame.size.height+BUTTON_INTERVAL_HEIGHT/2-20;
            }
            else{
                self.LXActionSheetHeight = self.LXActionSheetHeight + destructiveButton.frame.size.height+BUTTON_INTERVAL_HEIGHT-20;
            }
        }
        else{
            //当无title时
...
//    
    //otherButton.backgroundColor = OTHER_BUTTON_COLOR;X
//    [otherButton setBackgroundImage:[UIImage imageNamed:@"Login_Button"] forState:UIControlStateNormal];
    otherButton.backgroundColor = MCN_buttonColor;
...
//    
    ...
    cancelButton.backgroundColor = [UIColor mcn_colorWithHex:0xD9D6CF];
    return cancelButton;
