...
- (void)initView {
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.cropFrame.size.width, self.cropFrame.size.height)];
...
- (void)initControlBtn {
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - self.view.frame.size.width/2, self.view.frame.size.height - 50.0f, self.view.frame.size.width/2, 50)];
...
-(UIImage *)getSubImage{
    ...
    CGImageRef imageRef = [self fixOrientation:self.originalImage].CGImage;
