...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.showView =[[UIView alloc]initWithFrame:CGRectMake(0, SCREEN_H-pic_H, SCREEN_W, pic_H)];
        //self.showView.backgroundColor =[UIColor blackColor];
        [self addSubview:self.showView];
        self.toolView =[[UIView alloc]initWithFrame:CGRectMake(0, SCREEN_H-pic_H,SCREEN_W,ZHToobarHeight)];
...
-(void)setUpPickView{
    ...
    [self.showView addSubview:pickView];
}
...
-(void)setUpToolBar{
    ...
    _toolbar.tintColor =[UIColor greenColor];
    _toolbar.frame=CGRectMake(0, 0, SCREEN_W, ZHToobarHeight);
    [self.toolView addSubview:_toolbar];
}
...
-(void)doneClick
{
    if (_pickerView) {
        ...
        NSString  *date= [formater stringFromDate:_datePicker.date];
        _resultString=date;
    }
