...
-(void)setAction:(void (^)(NSDate *firstDate))action{
...
//        _action(currentDate);
//    }
//        [[NSNotificationCenter defaultCenter] postNotificationName:@"Change" object: currentDate];
//
