...
//        [self.rightBtn setBackgroundImage:[UIImage imageNamed:@"Login_Button"] forState:UIControlStateNormal];
        self.rightBtn.backgroundColor = MCN_buttonColor;
 
        [self.leftBtn setBackgroundImage:[UIImage imageNamed:@"textField_circle"] forState:UIControlStateNormal];
        [self.rightBtn setTitle:rigthTitle forState:UIControlStateNormal];
        [self.leftBtn setTitle:leftTitle forState:UIControlStateNormal];
        self.leftBtn.titleLabel.font = self.rightBtn.titleLabel.font = [UIFont boldSystemFontOfSize:14];
        [self.leftBtn setTitleColor:MCN_buttonColor forState:UIControlStateNormal];
        ...
        [self.xButton setImage:[UIImage imageNamed:@"btn_close_normal.png"] forState:UIControlStateNormal];
        [self.xButton setImage:[UIImage imageNamed:@"btn_close_selected.png"] forState:UIControlStateHighlighted];
        self.xButton.frame = CGRectMake(kAlertWidth - 32, 0, 32, 32);
        [self addSubview:self.xButton];
        [self.xButton addTarget:self action:@selector(dismissAlert) forControlEvents:UIControlEventTouchUpInside];
        
        self.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleTopMargin;
    }
    _rightBtn.layer.cornerRadius = 20;
    //        [self.rightBtn.layer setCornerRadius:15.0];
