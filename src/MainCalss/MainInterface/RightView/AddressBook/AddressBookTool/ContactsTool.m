...
@property(nonatomic, strong) AddressBookModel *contactModel;
...
- (void)peoplePickerNavigationController:(ABPeoplePickerNavigationController *)peoplePicker didSelectPerson:(ABRecordRef)person {
    ...
    AddressBookModel *model = [[AddressBookModel alloc] initWithName:name phoneNum:phoneValue];
...
- (void)contactPicker:(CNContactPickerViewController *)picker didSelectContact:(CNContact *)contact {
    ...
    AddressBookModel *model = [[AddressBookModel alloc] initWithName:name phoneNum:[NSString stringWithFormat:@"%@", phoneNumber.stringValue]];
...
+ (NSMutableArray *)getContactsInfo:(CNContactStore *)store {
    ...
    [store enumerateContactsWithFetchRequest:request error:nil usingBlock:^(CNContact * _Nonnull contact, BOOL * _Nonnull stop) {
        ...
        for (CNLabeledValue *labeledValue in contact.phoneNumbers) {
            ...
            NSLog(@"电话号码: %@", phoneNumber.stringValue);
            AddressBookModel *model = [[AddressBookModel alloc] initWithName:name phoneNum:phoneNumber.stringValue];
            [contactModels addObject:model];
        }
    }];
